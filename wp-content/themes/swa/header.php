...
<head>
	...
	// Logic for videos single posts structured data
			...
			<script type="application/ld+json">
				{
				  ...
				  "@type": "VideoObject",
				  "name": "<?php echo get_field('voName'); ?>",
				  "description": "<?php echo get_field('voDescription'); ?>",
				  "thumbnailUrl": [
				    "<?php echo get_field('voThumbnailUrl'); ?>"
				   ],
				  "uploadDate": "<?php echo get_field('voUploadDate'); ?>",
				  "contentUrl": "",
				  "embedUrl": "<?php echo get_field('voEmbedUrl'); ?>",
				  "duration": "<?php echo get_field('voDuration'); ?>"
				}
			</script>
		<?php
	}
