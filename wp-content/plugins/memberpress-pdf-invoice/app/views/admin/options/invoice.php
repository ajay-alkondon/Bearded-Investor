...
<table class="form-table">
  <tbody>
    ...
    <tr valign="top">
      <th scope="row">
        <label for="<?php echo $mepr_options->attr_slug( 'pf_inv_starting_number' ); ?>"><?php _e( 'Next Proforma Invoice No.', 'memberpress-pdf-invoice' ); ?></label>
      </th>
      <td>
        <div class="mb-5">
          <input type="text" class="regular-text" name="<?php echo $mepr_options->attr_slug( 'pf_inv_starting_number' ); ?>" value="<?php echo $mepr_options->attr( 'pf_inv_starting_number' ); ?>" id="mepr-pf-invoice-no"><br/>
          <small><?php echo esc_html__('NOTICE: Updating this field will reset the pro-forma invoice number to the updated number. Please keep in mind that you can’t reset the pro-forma invoice number to a smaller value than the current one.', 'memberpress-pdf-invoice'); ?></small>
        </div>
      </td>
    </tr>
    <tr valign="top">
