...
use MemberPress\PdfInvoice\Mpdf\MpdfException;
...
class MePdfMPDF extends MePdfBaseGenerator {
  ...
  public function get_tempdir() {
    ...
    $upload_dir = $upload_dir . DIRECTORY_SEPARATOR . 'mepr' . DIRECTORY_SEPARATOR . 'mpdf' . DIRECTORY_SEPARATOR;

    if ( is_dir( $upload_dir ) ) {
      return $upload_dir;
    }
    // Default
    return MPDFINVOICE_PATH . 'vendor-prefixed/mpdf/mpdf/tmp';
  }
