...
class Tag
{
	...
	/**
	 * @param \MemberPress\PdfInvoice\Mpdf\Mpdf $mpdf
	 * @param \MemberPress\PdfInvoice\Mpdf\Cache $cache
	 * @param \MemberPress\PdfInvoice\Mpdf\CssManager $cssManager
	 * @param \MemberPress\PdfInvoice\Mpdf\Form $form
	 * @param \MemberPress\PdfInvoice\Mpdf\Otl $otl
	 * @param \MemberPress\PdfInvoice\Mpdf\TableOfContents $tableOfContents
	 * @param \MemberPress\PdfInvoice\Mpdf\SizeConverter $sizeConverter
	 * @param \MemberPress\PdfInvoice\Mpdf\Color\ColorConverter $colorConverter
	 * @param \MemberPress\PdfInvoice\Mpdf\Image\ImageProcessor $imageProcessor
	 * @param \MemberPress\PdfInvoice\Mpdf\Language\LanguageToFontInterface $languageToFont
	 */
	 ...
	 * @return \MemberPress\PdfInvoice\Mpdf\Tag\Tag
	 */
	...
	public static function getTagClassName($tag)
	{
		...
		$className = 'MemberPress\PdfInvoice\Mpdf\Tag\\';
