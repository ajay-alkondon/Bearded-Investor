...
namespace MemberPress\PdfInvoice\Mpdf\PsrHttpMessageShim;

use MemberPress\PdfInvoice\Psr\Http\Message\StreamInterface;
use MemberPress\PdfInvoice\Psr\Http\Message\ResponseInterface;
use MemberPress\PdfInvoice\Psr\Http\Message\MessageInterface;
 ...
 */
class Response implements \MemberPress\PdfInvoice\Psr\Http\Message\ResponseInterface
{
	...
	/** @var \MemberPress\PdfInvoice\Psr\Http\Message\StreamInterface */
	private $stream;
