...
class Drip
{
    ...
    public static function generate_time_intervals($start, $end, $interval)
    {
        // Input validation
        if (
            !preg_match('/^(0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$/', $start) ||
     ...
     * @param  integer $number    The number associated with the drip type.
    ...
    {
        return isset(self::$drip_track[$content_id]) ? self::$drip_track[$content_id] : [];
    }
}
