...
abstract class BaseEmail
{
    ...
    {
        /**
         * Filter to suppress the email from being sent.
         *
         * @param boolean $suppress Whether to suppress sending the email. Default false.
         * @param BaseEmail $email The email object being sent.
         *
         * @return boolean True to suppress sending, false to proceed normally.
         */
        if (apply_filters('mpcs_email_send_suppress', false, $this)) {
            return;
        }
        ...
        $attachments = apply_filters('mpcs_email_send_attachments', [], $this, $body, $values);
