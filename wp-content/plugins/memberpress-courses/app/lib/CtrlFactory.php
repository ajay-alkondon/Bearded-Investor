...
class CtrlFactory
{
    public static function fetch($class, $args = [])
    {
        ...
        if (!class_exists($class)) {
            throw new \Exception(sprintf(__('Ctrl: %s wasn\'t found', 'memberpress-courses'), $class));
        }
    ...
    {
        return apply_filters(base\SLUG_KEY . '_ctrls_paths', [base\CTRLS_PATH, base\ADMIN_CTRLS_PATH]);
    }
}
