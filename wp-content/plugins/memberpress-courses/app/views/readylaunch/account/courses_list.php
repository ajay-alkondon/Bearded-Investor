...
<div class="mp_wrapper mpcs-course-list">
  ...
  <?php printf('<h1 class="mepr_page_header">%s</h1>', esc_html_x('My Courses', 'ui', 'memberpress-courses')); ?>

  <?php foreach ($my_courses as $course) : ?>
    <div class="grid">
      <div class="col-1-2 grid-pad">
        <a id="course-progress-label-<?php echo $course->post_name; ?>" href="<?php echo get_permalink($course->ID); ?>">
          <?php echo $course->post_title; ?>
        </a>
      </div>
      <div class="col-1-2 grid-pad">
        <?php if ($show_bookmark === true) : ?>
          <div class="course-progress" role="progressbar" aria-labelledby="course-progress-label-<?php echo $course->post_name; ?>" aria-valuenow="<?php echo $course->user_progress($current_user->ID); ?>">
