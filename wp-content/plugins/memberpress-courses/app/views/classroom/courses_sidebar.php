        ...
        <a target="_blank" class="tile <?php \MeprAccountHelper::active_nav('certificate', 'is-active') ?>" href="<?php echo esc_url_raw($cert_url); ?>">
          ...
          <div class="tile-content">
            <p class="tile-title m-0"><?php esc_html_e('Certificate', 'memberpress-courses') ?>
              <?php if ($course->certificates_share_link == 'enabled') { ?><i title="<?php esc_attr_e('Copied Shareable Certificate Link', 'memberpress-courses') ?>" class="mpcs-share" data-clipboard-text="<?php echo esc_url($share_link); ?>" onclick="return false;"></i><?php } ?>
            </p>
          </div>
        </a>
        <?php } ?>
