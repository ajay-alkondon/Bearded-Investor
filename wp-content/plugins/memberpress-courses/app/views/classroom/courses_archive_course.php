        ...
        <div class="dropdown">
          ...
          <ul class="menu" role="menu" aria-labelledby="categories-dropdown-button">
            <?php
              ...
              printf('<li><label for="mpcs-dropdown-category-search" class="screen-reader-text">%s</label><input type="text" id="mpcs-dropdown-category-search" class="form-input mpcs-dropdown-search" placeholder="%s"></li>', esc_html__('Search', 'memberpress-courses'), esc_html__('Search', 'memberpress-courses'));
        ...
        <div class="dropdown">
          ...
          <ul class="menu" role="menu" aria-labelledby="authors-dropdown-button">
            <?php
              ...
              printf('<li><label for="mpcs-dropdown-author-search" class="screen-reader-text">%s</label><input type="text" id="mpcs-dropdown-author-search" class="form-input mpcs-dropdown-search" placeholder="%s"></li>', esc_html__('Search', 'memberpress-courses'), esc_html__('Search', 'memberpress-courses'));
      ...
      <div class="column col-sm-12">
        <form method="GET" class="" action="<?php echo esc_url($courses_page) ?>">
          <div class="input-group">
            <label for="mpcs-search" class="screen-reader-text"><?php _e('Find a course', 'memberpress-courses') ?></label>
            <input type="text" name="s" id="mpcs-search" class="form-input form-input-search" placeholder="<?php _e('Find a course', 'memberpress-courses') ?>" value="<?php echo $search ?>">
            <button class="btn input-group-btn" aria-label="<?php _e('Find a course', 'memberpress-courses') ?>"><i class="mpcs-search form-icon"></i></button>
          </div>
        </form>
          ...
          <div class="card-image">
            ...
            <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                <?php if (has_post_thumbnail()) :
                    the_post_thumbnail(apply_filters('mpcs_course_thumbnail_size', 'mpcs-course-thumbnail'), ['class' => 'img-responsive']);
                else : ?>
                <img src="<?php echo base\IMAGES_URL . '/course-placeholder.png' ?>" class="img-responsive" alt="<?php the_title_attribute(); ?>">
                <?php endif; ?>
            </a>
          </div>
