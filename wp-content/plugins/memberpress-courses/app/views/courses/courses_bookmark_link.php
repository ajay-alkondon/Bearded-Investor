...
<div class="mpcs-bookmark" id="bookmark_link">
  <a class="mpcs-bookmark-link mpcs-button is-rounded" href="<?php echo isset($bookmark_url) ? $bookmark_url : get_permalink($course->ID) ; ?>" title="<?php echo isset($lesson->post_title) ? $lesson->post_title : __('Completed', 'memberpress-courses'); ?>">
