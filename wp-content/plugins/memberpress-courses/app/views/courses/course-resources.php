<h1><?php esc_html_e('Resources', 'memberpress-courses') ?></h1>

<?php if (!empty($resources->downloads)) : ?>
  <div id="downloads" class="mpcs-section mpcs-resource-section">
    <button class="mpcs-section-header active" aria-expanded="true" aria-controls="mpcs-lessons-downloads">
    ...
    <div id="mpcs-lessons-downloads" class="mpcs-lessons" style="display: block;">
...
<?php if (!empty($resources->links)) : ?>
  <div id="links" class="mpcs-section mpcs-resource-section">
    <button class="mpcs-section-header active" aria-expanded="true" aria-controls="mpcs-lessons-links">
      <div class="mpcs-section-title">
    ...
    <div id="mpcs-lessons-links" class="mpcs-lessons" style="display: block;">
