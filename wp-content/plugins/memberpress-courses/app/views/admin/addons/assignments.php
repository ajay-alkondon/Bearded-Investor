...
<div class="wrap">
  ...
  <div class="mepr-sister-plugin mepr-sister-plugin-wp-mail-smtp">
    ...
    <div class="mepr-sister-plugin-image mp-courses-image">
      <img src="<?php echo esc_url(base\IMAGES_URL . '/add-ons/assignments-icon.png'); ?>" height="216" alt="" />
    </div>

    <div class="mepr-sister-plugin-title">
      <?php esc_html_e('Enhance your teaching with MemberPress Courses’ new Assignments add-on', 'memberpress-courses'); ?>
    </div>
    ...
    <div class="mepr-sister-plugin-info mepr-clearfix">
      <div class="mepr-sister-plugin-info-image">
        <div>
          <img src="<?php echo esc_url(base\IMAGES_URL . '/add-ons/assignments-screenshot.png'); ?>" alt="">
        </div>
      </div>
    ...
    <div class="mepr-sister-plugin-step mepr-sister-plugin-step-no-number mepr-sister-plugin-step-current mepr-clearfix">
      <div class="mepr-sister-plugin-step-detail">
        <div class="mepr-sister-plugin-step-title">
          <?php if (! empty($plugins['memberpress-course-assignments/main.php'])) : // Installed but not active ?>
                <?php esc_html_e('Enable MemberPress Course Assignments', 'memberpress-courses'); ?>
          <?php else : // Not installed ?>
              <?php esc_html_e('Install and Activate MemberPress Course Assignments', 'memberpress-courses'); ?>
          <?php endif; ?>
        </div>
        <div class="mepr-sister-plugin-step-button">
          <?php if (! empty($plugins['memberpress-course-assignments/main.php'])) : // Installed but not active ?>
            <button type="button" class="mepr-courses-addon-action button button-primary button-hero" data-action="activate" data-addon="assignments"><?php esc_html_e('Activate Add-On', 'memberpress-courses'); ?></button>
          <?php else : // Not installed ?>
            <button type="button" class="mepr-courses-addon-action button button-primary button-hero" data-action="install-activate" data-addon="assignments"><?php esc_html_e('Install & Activate Add-On', 'memberpress-courses'); ?></button>
          <?php endif; ?>
        </div>
