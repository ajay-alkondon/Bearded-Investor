...
class Drip extends lib\BaseCtrl
{
    ...
    {
        add_filter('template_include', [$this, 'run_dripping'], 1);
        add_filter('mepr_last_chance_to_block_content', [$this,'maybe_block_content'], 99, 3);
        add_filter('mepr_unauthorized_content', [$this,'maybe_render_unauthorized_message'], 99, 3);
    }
    ...
    public function run_dripping($template, $current_post = null, $user_id = 0)
    {
        ...
        if ($current_post === false || 0 === $user_id) {
            return $template;
        }
        ...
        $bypass_user_roles = apply_filters('mpcs_dripping_bypass_user_roles', ['administrator'], $course, $current_post);
        ...
        try {
            ...
            if (is_array($item_info) && !empty($item_info) && isset($item_info['current_index'])) {
                ...
                if (! $is_content_available) {
                    helpers\Drip::set_data($current_post->ID, [
