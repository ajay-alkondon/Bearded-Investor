...
class CoursesApi extends lib\BaseCtrl
{
    ...
    {
        register_rest_route(self::$namespace_str, '/' . self::$resource_name_str . '/lessons', [
            [
                'methods'             => \WP_REST_Server::READABLE,
                'callback'            => [$this, 'fetch_lessons'],
                'permission_callback' => [$this, 'fetch_lessons_permissions_check'],
            ],
        ]);

        register_rest_route(self::$namespace_str, '/' . self::$resource_name_str . '/lessons/(?P<id>[\d]+)', [
            [
        ...
        register_rest_route(self::$namespace_str, '/' . self::$resource_name_str . '/curriculum/(?P<id>[\d]+)', [
            [
                'methods'             => \WP_REST_Server::READABLE,
                'callback'            => [$this, 'get_curriculum'],
                'permission_callback' => [$this, 'fetch_lessons_permissions_check'],
            ],
        ]);

        register_rest_route(self::$namespace_str, '/' . self::$resource_name_str . '/validate/links', [
            [
                'methods'             => \WP_REST_Server::CREATABLE,
                'callback'            => [$this, 'validate_links_fields'],
                'permission_callback' => [$this, 'fetch_lessons_permissions_check'],
            ],
        ]);
