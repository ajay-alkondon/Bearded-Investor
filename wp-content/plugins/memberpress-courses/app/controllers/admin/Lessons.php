...
class Lessons extends lib\BaseCptCtrl
{
    public function load_hooks()
    {
        ...
        add_action('manage_mpcs-lesson_posts_custom_column', [$this, 'custom_column_content'], 10, 2);
        add_action('admin_enqueue_scripts', [$this, 'admin_enqueue_scripts']);
        add_action('enqueue_block_editor_assets', [$this, 'enqueue_block_editor_assets']);
        add_filter('post_row_actions', [$this, 'duplicate_post_link'], 10, 2);
        add_filter('manage_mpcs-lesson_posts_columns', [$this, 'alter_columns']);
    ...
    public function register_post_type()
    {
        $this->cpt = (object)[
            ...
            'config' => [
                ...
                'hierarchical'       => false,
                'rewrite'            => [
                    'slug'       => '/' . helpers\Courses::get_permalink_base() . '/%course_slug%/' . helpers\Lessons::get_permalink_base(),
                    'with_front' => false,
                ],
