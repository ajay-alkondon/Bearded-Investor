...
class Emails extends lib\BaseCtrl
{
    ...
    public function load_hooks()
    {
        ...
        add_action('admin_menu', [$this, 'add_sub_menu'], 80);
        add_filter("manage_{$hook}_columns", [$this, 'get_columns'], 0);
        add_action("load-{$hook}", [$this, 'add_screen_options']);
        add_action('admin_enqueue_scripts', [$this, 'admin_enqueue_scripts']);
        add_action('media_buttons', [$this, 'add_tinymce_button']);
        add_action('wp_ajax_mpcs_reset_default_content', [$this, 'reset_editor_default_content']);
        add_action('wp_ajax_mpcs_emails_enable_single_email', [$this, 'enable_single_email']);
        add_action('wp_ajax_mpcs_send_test_email', [$this, 'send_test_email']);
        add_action('mpcs_admin_options_tab', [$this, 'add_options_tab'], 9);
        add_action('mpcs_admin_options_tab_content', [$this, 'add_options_tab_content']);
    }
    ...
    public function admin_enqueue_scripts($hook)
    {
        if (is_admin() && strstr($hook, 'memberpress-courses-emails') !== false) {
            \wp_enqueue_style('mpcs-emails', base\CSS_URL . '/admin_emails.css', [], base\VERSION);
            wp_enqueue_script('mpcs-emails', base\JS_URL . '/admin_emails.js', ['jquery', 'editor'], base\VERSION, true);
