...
namespace memberpress\courses\Dompdf\Adapter;

use memberpress\courses\Dompdf\Canvas;
...
use memberpress\courses\Dompdf\Image\Cache;
...
class CPDF implements Canvas
{
     ...
     *
     * @var \memberpress\courses\Dompdf\Cpdf
     */
    protected $_pdf;
    ...
    public function __construct($paper = "letter", string $orientation = "portrait", ?Dompdf $dompdf = null)
    {
        ...
        $this->_pdf = new \memberpress\courses\Dompdf\Cpdf(
            $size,
            true,
     ...
     *
     * @return \memberpress\courses\Dompdf\Cpdf
     */
    ...
    public function select($x, $y, $w, $h, $font, $size, $color = [0, 0, 0], $opts = [])
    {
        ...
        $ft = \memberpress\courses\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE;
        $ff = \memberpress\courses\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE_COMBO;
    ...
    public function textarea($x, $y, $w, $h, $font, $size, $color = [0, 0, 0])
    {
        ...
        $ft = \memberpress\courses\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
        $ff = \memberpress\courses\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_MULTILINE;
    ...
    public function input($x, $y, $w, $h, $type, $font, $size, $color = [0, 0, 0])
    {
        ...
        switch ($type) {
            ...
            case 'password':
                $ft = \memberpress\courses\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
                $ff = \memberpress\courses\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_PASSWORD;
                break;
            case 'submit':
                $ft = \memberpress\courses\Dompdf\Cpdf::ACROFORM_FIELD_BUTTON;
                break;
        }
