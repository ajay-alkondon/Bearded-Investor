...
use memberpress\courses\Dompdf\Frame\FrameTree;
use memberpress\courses\Dompdf\Image\Cache;
use memberpress\courses\Dompdf\Css\Stylesheet;
use memberpress\courses\Dompdf\Helpers;
use memberpress\courses\Masterminds\HTML5;
...
class Dompdf
{
    ...
    */
    ...
    /**
     * Return the underlying Canvas instance (e.g. memberpress\courses\Dompdf\Adapter\CPDF, memberpress\courses\Dompdf\Adapter\GD)
     *
     * @return Canvas
     */
