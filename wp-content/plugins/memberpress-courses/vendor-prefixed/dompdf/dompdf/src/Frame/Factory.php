 ...
 */
namespace memberpress\courses\Dompdf\Frame;
...
use memberpress\courses\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use memberpress\courses\Dompdf\FrameReflower\Page as PageFrameReflower;
use memberpress\courses\Dompdf\Positioner\AbstractPositioner;
use DOMXPath;
...
class Factory
{
    ...
    public static function decorate_frame(Frame $frame, Dompdf $dompdf, ?Frame $root = null): ?AbstractFrameDecorator
    {
        ...
        $decorator  = "memberpress\\courses\\Dompdf\\FrameDecorator\\$decorator";
        $reflower   = "memberpress\\courses\\Dompdf\\FrameReflower\\$reflower";
    ...
    protected static function getPositionerInstance(string $type): AbstractPositioner
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\memberpress\\courses\\Dompdf\\Positioner\\'.$type;
