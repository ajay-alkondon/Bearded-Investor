...
class MeprCoupon extends MeprCptModel
{
    ...
    public function update_usage_count()
    {
        ...
        $sqcount = $wpdb->get_var($wpdb->prepare(
        ...
        $lqcount = $wpdb->get_var($wpdb->prepare(
            // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared
    ...
    ";
        ...
        $subscription_query_count = $wpdb->get_var($wpdb->prepare(
    ...
    ";
        ...
        $lifetime_query_count = $wpdb->get_var($wpdb->prepare(
