  ...
  <form name="mepr_signup_form" id="mepr_signup_form" class="mepr-signup-form mepr-form" method="post" action="<?php echo esc_url(esc_url_raw(wp_unslash($_SERVER['REQUEST_URI'])) . '#mepr_jump'); ?>" enctype="multipart/form-data" novalidate>
    ...
    (!MeprUtils::is_user_logged_in() ||
      ...
      <div class="mp-form-row mepr_first_name<?php echo ($mepr_options->require_fname_lname) ? ' mepr-field-required' : ''; ?>">
        <div class="mp-form-label">
          <label for="user_first_name<?php echo $unique_suffix; ?>"><?php echo esc_html_x('First Name:', 'ui', 'memberpress');
      ...
      <div class="mp-form-row mepr_last_name<?php echo ($mepr_options->require_fname_lname) ? ' mepr-field-required' : ''; ?>">
        <div class="mp-form-label">
          <label for="user_last_name<?php echo $unique_suffix; ?>"><?php echo esc_html_x('Last Name:', 'ui', 'memberpress');
            echo ($mepr_options->require_fname_lname) ? '*' : ''; ?></label>
    ...
    <?php else : ?>
      <input type="hidden" class="mepr-geo-country" name="mepr-geo-country" value="" />
        ...
        <div class="mp-form-row mepr_username mepr-field-required">
          <div class="mp-form-label">
            <label for="user_login<?php echo $unique_suffix; ?>"><?php echo esc_html_x('Username:*', 'ui', 'memberpress'); ?></label>
      ...
      <div class="mp-form-row mepr_email_stripe mepr-field-required mepr-hidden">
        ...
        <div class="mp-form-row mepr_password mepr-field-required">
          <div class="mp-form-label">
            <label for="mepr_user_password<?php echo $unique_suffix; ?>"><?php echo esc_html_x('Password:*', 'ui', 'memberpress'); ?></label>
        ...
        <div class="mp-form-row mepr_password_confirm mepr-field-required">
          <div class="mp-form-label">
            <label for="mepr_user_password_confirm<?php echo $unique_suffix; ?>"><?php echo esc_html_x('Password Confirmation:*', 'ui', 'memberpress'); ?></label>
    ...
    <?php if ($payment_required || !empty($product->plan_code)) : ?>
        ...
        <div class="mp-form-row mepr_coupon mepr_coupon_<?php echo $product->ID; ?> mepr-hidden">
          <div class="mp-form-label">
            <label for="mepr_coupon_code-<?php echo $product->ID; ?>"><?php echo esc_html_x('Coupon Code:', 'ui', 'memberpress'); ?></label>
            <span class="mepr-coupon-loader mepr-hidden">
              <img src="<?php echo includes_url('js/thickbox/loadingAnimation.gif'); ?>" title="<?php echo esc_attr_x('Loading icon', 'ui', 'memberpress'); ?>" alt="<?php echo esc_attr_x('Loading icon', 'ui', 'memberpress'); ?>" width="100" height="10" />
            </span>
    ...
    <div class="mp-form-submit">
      ...
      <?php endif; ?>
      <img src="<?php echo admin_url('images/loading.gif'); ?>" alt="<?php esc_attr_e('Loading...', 'memberpress'); ?>" style="display: none;" class="mepr-loading-gif" title="<?php echo esc_attr_x('Loading icon', 'ui', 'memberpress'); ?>" />
