...
<div id="mepr-integration-<?php echo $obj->id; ?>" class="mepr-integration" data-id="<?php echo $obj->id; ?>" data-gateway="<?php echo get_class($obj); ?>">
  ...
  <div class="mp-row">
    <div class="mepr-integration-setup-form">
      ...
      <div class="mp-row">
        <strong><?php esc_html_e('Name:', 'memberpress'); ?></strong>
      ...
      <div class="mp-row">
        <strong><?php esc_html_e('Gateway:', 'memberpress'); ?></strong>
        <?php
      ...
      <div class="mp-row">
        <strong><?php esc_html_e('ID:', 'memberpress'); ?></strong>
        <?php echo $obj->id; ?>
      </div>
      <div class="mp-row">
        <div><label><input type="checkbox" id="<?php echo "{$mepr_options->integrations_str}-{$obj->id}-use_label"; ?>" name="<?php echo "{$mepr_options->integrations_str}[{$obj->id}][use_label]"; ?>" value="<?php echo $obj->use_label; ?>" <?php checked($obj->use_label); ?> />&nbsp;&nbsp;<?php esc_html_e('Show Payment Label', 'memberpress'); ?></label></div>
        <div><label><input type="checkbox" id="<?php echo "{$mepr_options->integrations_str}-{$obj->id}-use_icon"; ?>" name="<?php echo "{$mepr_options->integrations_str}[{$obj->id}][use_icon]"; ?>" value="<?php echo $obj->use_icon; ?>" <?php checked($obj->use_icon); ?> />&nbsp;&nbsp;<?php esc_html_e('Show Payment Icon', 'memberpress'); ?></label></div>
        <div><label><input type="checkbox" id="<?php echo "{$mepr_options->integrations_str}-{$obj->id}-use_desc"; ?>" name="<?php echo "{$mepr_options->integrations_str}[{$obj->id}][use_desc]"; ?>" value="<?php echo $obj->use_desc; ?>" <?php checked($obj->use_desc); ?> />&nbsp;&nbsp;<?php esc_html_e('Show Payment Description', 'memberpress'); ?></label></div>
      </div>
    </div>
