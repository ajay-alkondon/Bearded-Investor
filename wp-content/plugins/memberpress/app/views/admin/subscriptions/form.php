...
<tr valign="top">
  ...
  <td>
    <select name="status" id="status">
      <option value="<?php echo MeprSubscription::$active_str; ?>" <?php echo selected($sub->status, MeprSubscription::$active_str); ?>><?php esc_html_e('Enabled', 'memberpress'); ?></option>
      <option value="<?php echo MeprSubscription::$pending_str; ?>" <?php echo selected($sub->status, MeprSubscription::$pending_str); ?>><?php esc_html_e('Pending', 'memberpress'); ?></option>
      <option value="<?php echo MeprSubscription::$suspended_str; ?>" <?php echo selected($sub->status, MeprSubscription::$suspended_str); ?>><?php esc_html_e('Paused', 'memberpress'); ?></option>
      <option value="<?php echo MeprSubscription::$cancelled_str; ?>" <?php echo selected($sub->status, MeprSubscription::$cancelled_str); ?>><?php esc_html_e('Stopped', 'memberpress'); ?></option>
    </select>
...
<tr valign="top">
  <th scope="row"><label for="trial_amount"><?php printf(
