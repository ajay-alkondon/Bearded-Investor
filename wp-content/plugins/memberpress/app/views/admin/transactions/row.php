                ...
                switch ($column_name) {
                    ...
                    case 'col_expires_at':
                        ...
                        <td <?php echo $attributes; ?>>
                            <?php echo MeprAppHelper::format_date($rec->expires_at, esc_html__('Never', 'memberpress')); ?>
                        </td>
                        <?php
                        break;
                    case 'col_user_login':
                    ...
                    case 'col_product':
                        if ($rec->product_id) {
                            ...
                            $product_link = '<a href="' . esc_url($prd->edit_url()) . '">' . esc_html($rec->product_name) . '</a>';
                        } else {
                            $product_link = esc_html__('Unknown', 'memberpress');
                        }
                        ?>
                    ...
                    case 'col_payment_system':
                        ?>
                        <td <?php echo $attributes; ?>><?php echo esc_html($rec->gateway); ?></td>
                        <?php
                        break;
                    case 'col_trans_num':
                        ?>
                        <td <?php echo $attributes; ?>>
                            <a href="<?php echo esc_url(admin_url('admin.php?page=memberpress-trans&action=edit&id=' . $rec->id)); ?>"
                                title="<?php esc_attr_e('Edit transaction', 'memberpress'); ?>" <?php echo MeprTransactionsHelper::get_tooltip_attributes($rec); ?>><b><?php echo esc_html($rec->trans_num); ?></b></a> <img
                                src="<?php echo esc_url(MEPR_IMAGES_URL . '/square-loader.gif'); ?>" alt="<?php esc_attr_e('Loading...', 'memberpress'); ?>"
                                class="mepr_loader" />
                            <div class="mepr-row-actions">
                                <?php echo MeprUtils::render_row_action_links(MeprTransactionsHelper::get_admin_action_links($rec)); ?>
                            </div>
                        </td>
                        <?php
                        break;
