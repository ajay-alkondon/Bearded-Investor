      ...
      <tr valign="top">
        ...
        <td>
          <p>
            ...
            <label for="<?php echo $mepr_options->auto_updates_str; ?>_all"><?php printf(
          ...
          <p>
            ...
            <label for="<?php echo $mepr_options->auto_updates_str; ?>_minor"><?php printf(
                // Translators: %1$s: opening strong tag, %2$s: closing strong tag.
          ...
          <p>
            ...
            <label for="<?php echo $mepr_options->auto_updates_str; ?>_none"><?php printf(
                // Translators: %1$s: opening strong tag, %2$s: closing strong tag.
