...
<?php } elseif (false !== $upgrade_type || $mepr_onboarding_payment_gateway === 'MeprAuthorizeGateway') {
    ...
    if (
        MeprOnboardingHelper::is_elite_edition(MEPR_EDITION) || MeprOnboardingHelper::is_pro_edition(MEPR_EDITION) ||
        MeprOnboardingHelper::is_elite_edition($current_license) || MeprOnboardingHelper::is_pro_edition($current_license)
    ) {
    ...
    <p class="mepr-wizard-step-description"><?php esc_html_e("Please don't close the browser.", 'memberpress'); ?> <i class="mp-icon mp-icon-spinner animate-spin mepr-wizard-finish-step-processing"></i></p>
    <div class="mepr-wizard-features">
