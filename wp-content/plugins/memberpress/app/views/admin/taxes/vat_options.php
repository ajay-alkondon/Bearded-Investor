...
<tr valign="top">
  <th scope="row">
    <label for="mepr_vat_enabled"><?php esc_html_e('Enable VAT', 'memberpress'); ?></label>
      ...
      <table class="form-table">
        <tbody>
          <tr valign="top" id="mepr_vat_country_section">
            <th scope="row">
              <label for="mepr_vat_country"><?php esc_html_e('Merchant VAT Country', 'memberpress'); ?></label>
              <?php MeprAppHelper::info_tooltip(
          ...
          <tr valign="top" id="mepr_vat_tax_businesses_section">
            <th scope="row">
              <label for="mepr_vat_tax_businesses"><?php esc_html_e('Tax all EU Businesses', 'memberpress'); ?></label>
              <?php MeprAppHelper::info_tooltip(
          ...
          <tr valign="top" id="mepr_charge_business_customer_net_price_section">
            <th scope="row">
              <label for="mepr_charge_business_customer_net_price"><?php esc_html_e('Remove tax from valid Businesses', 'memberpress'); ?></label>
              <?php MeprAppHelper::info_tooltip(
          ...
          <tr valign="top" id="mepr_show_negative_tax_on_invoice_section"<?php echo ((int) $charge_business_customer_net_price !== 1) ? " style='display:none;'" : ''; ?>>
            <th scope="row">
              <label for="mepr_show_negative_tax_on_invoice"><?php esc_html_e('Show negative tax on Invoice', 'memberpress'); ?></label>
              <?php MeprAppHelper::info_tooltip(
          ...
          <tr valign="top">
            <th scope="row">
              <label for="mepr_vat_disable_vies_service"><?php esc_html_e('Disable VAT VIES database lookup', 'memberpress'); ?></label>
              <?php MeprAppHelper::info_tooltip(
