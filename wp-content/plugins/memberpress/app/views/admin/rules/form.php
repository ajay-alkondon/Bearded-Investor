  ...
  <div id="mepr-rules-form">
    ...
    <div class="mepr-main-pane">
      ...
      <div class="mepr-sub-box mepr-partial-codes mepr-hidden">
        ...
        <?php esc_html_e('Shortcode:', 'memberpress'); ?><br /><strong>[mepr_show rules="<?php echo $rule->ID; ?>" unauth="message"] </strong><?php esc_html_e('This content is shown only to authorized members. It is hidden from everyone else.', 'memberpress'); ?><strong> [/mepr_show]</strong>
        <br/><br/>
        <?php esc_html_e('Shortcode:', 'memberpress'); ?><br /><strong>[mepr_hide rules="<?php echo $rule->ID; ?>" unauth="message"] </strong><?php esc_html_e('This content is shown to everyone except authorized members.', 'memberpress'); ?><strong> [/mepr_hide]</strong>
        <br/><br/>
