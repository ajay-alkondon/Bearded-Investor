...
<div>
  <input type="checkbox" name="<?php echo MeprRule::$drip_enabled_str; ?>" id="<?php echo MeprRule::$drip_enabled_str; ?>" <?php checked((!empty($rule->drip_enabled))); ?> /> <label for="<?php echo MeprRule::$drip_enabled_str; ?>"><strong><?php esc_html_e('Enable Drip', 'memberpress'); ?></strong></label>
...
<div>
  <input type="checkbox" name="<?php echo MeprRule::$expires_enabled_str; ?>" id="<?php echo MeprRule::$expires_enabled_str; ?>" <?php checked((!empty($rule->expires_enabled))); ?> /> <label for="<?php echo MeprRule::$expires_enabled_str; ?>"><strong><?php esc_html_e('Enable Expiration', 'memberpress'); ?></strong></label>
