...
<p class="search-box">
  ...
  <span class="search-fields">
    <span><?php esc_html_e('Search', 'memberpress'); ?></span>
    <input id="cspf-table-search" value="<?php echo esc_attr($search_term); ?>" />
    <span><?php esc_html_e('by Field', 'memberpress'); ?></span>
