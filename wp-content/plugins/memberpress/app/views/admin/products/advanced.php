...
<div class="product-options-panel">
  <div id="mepr-product-access-url">
    <label for="<?php echo MeprProduct::$access_url_str; ?>"><?php esc_html_e('Membership Access URL', 'memberpress'); ?></label>
  ...
  <div id="mepr-custom-login-redirect-urls">
    ...
    <label for="<?php echo MeprProduct::$custom_login_urls_enabled_str; ?>"><?php esc_html_e('Custom Login Redirect URLs', 'memberpress'); ?></label>
    <?php
        MeprAppHelper::info_tooltip(
