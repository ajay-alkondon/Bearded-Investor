...
<div class="product-options-panel">
  ...
  <div id="mepr-product-thank-you-page" class="mepr-product-adv-item">
    ...
    <label for="<?php echo MeprProduct::$thank_you_page_enabled_str; ?>"><?php esc_html_e('Enable custom thank you page message', 'memberpress'); ?></label>
    <?php
      MeprAppHelper::info_tooltip(
    ...
    <div id="mepr-product-thank-you-area">
      <div class="mepr-product-adv-item">
        <input type="radio" name="<?php echo MeprProduct::$thank_you_page_type_str; ?>" id="<?php echo MeprProduct::$thank_you_page_type_str; ?>_message" value="message" <?php checked(in_array($product->thank_you_page_type, ['message', ''], true)); ?> />
        <label for="<?php echo MeprProduct::$thank_you_page_type_str; ?>_message"><?php esc_html_e('Enable custom thank you message', 'memberpress'); ?></label>
        <?php
          MeprAppHelper::info_tooltip(
      ...
      <div class="mepr-product-adv-item">
        ...
        <label for="<?php echo MeprProduct::$thank_you_page_type_str; ?>_page"><?php esc_html_e('Enable custom thank you page', 'memberpress'); ?></label>
        <?php
          MeprAppHelper::info_tooltip(
  ...
  <div id="mepr-product-welcome-email">
    <?php MeprAppHelper::display_emails('MeprBaseProductEmail', [['product_id' => $product->ID]]); ?>
  </div>
  ...
  <div id="mepr-product-payment-methods-wrap">
    ...
    <label for="<?php echo MeprProduct::$customize_payment_methods_str; ?>"><?php esc_html_e('Customize Payment Methods', 'memberpress'); ?></label>
    <?php
      MeprAppHelper::info_tooltip(
  ...
  <div id="mepr-product-profile-fields-wrap">
    ...
    <label for="<?php echo MeprProduct::$customize_profile_fields_str; ?>"><?php esc_html_e('Customize User Information Fields', 'memberpress'); ?></label>
    <?php
      MeprAppHelper::info_tooltip(
  ...
  <?php if ($mepr_options->show_address_fields && $mepr_options->require_address_fields) : ?>
    <div id="mepr-product-disable-address-fields-wrap">
      ...
      <label for="<?php echo MeprProduct::$disable_address_fields_str; ?>"><?php esc_html_e('Disable Address Fields', 'memberpress'); ?></label>
        <?php
        MeprAppHelper::info_tooltip(
  ...
  <div id="mepr-product-manually-place-form">
    ...
    <div id="mepr-product-shortcodes" class="mepr-radius-border mepr-hidden">
      ...
      [mepr_membership_link id="<?php echo $product->ID; ?>"] <?php esc_html_e('Optional link label here...', 'memberpress'); ?> [/mepr_membership_link]<br/><br/>
      <?php if (!empty($product->access_url)) : ?>
        ...
        [mepr_membership_access_url id="<?php echo $product->ID; ?>"] <?php esc_html_e('Optional link label here...', 'memberpress'); ?> [/mepr_membership_access_url]<br/><br/>
      <?php endif; ?>
      ...
      [mepr_membership_registration_form id="<?php echo $product->ID; ?>"]
    </div>
  </div>
</div>
