...
<div class="product-options-panel">
  ...
  <div id="mepr-simultaneous-purchases">
    ...
    <label for="<?php echo MeprProduct::$simultaneous_subscriptions_str; ?>"><?php esc_html_e('Allow users to create multiple, active subscriptions to this membership', 'memberpress'); ?></label>
  </div>
  <br/>
  <?php } ?>
