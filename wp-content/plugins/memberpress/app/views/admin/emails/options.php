...
<div id="config-<?php echo $email->dashed_name(); ?>" class="mepr-config-email-row">
  ...
  <a href="#"
     ...
     data-body-id="<?php echo $email->field_name('body', true); ?>"><?php esc_html_e('Send Test', 'memberpress'); ?></a>
  <a href="#"
     ...
     data-use-template-id="<?php echo $email->field_name('use_template', true); ?>"
     data-body-id="<?php echo $email->field_name('body', true); ?>"><?php esc_html_e('Reset to Default', 'memberpress'); ?></a>
  <img src="<?php echo MEPR_IMAGES_URL . '/square-loader.gif'; ?>" alt="<?php esc_attr_e('Loading...', 'memberpress'); ?>" id="mepr-loader-<?php echo $email->dashed_name(); ?>" class="mepr_loader" />
    ...
    <ul>
      ...
      <li>
        ...
        <a href="#" class="button mepr-insert-email-var" data-variable-id="var-<?php echo $email->dashed_name(); ?>"
           data-textarea-id="<?php echo $email->field_name('body', true); ?>"><?php esc_html_e('Insert &uarr;', 'memberpress'); ?></a>
      </li>
      <li>
        <br/>
        <input type="checkbox"
