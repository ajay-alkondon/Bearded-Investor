...
<head>
  ...
  <title><?php esc_html_e('MemberPress database upgrade not needed', 'memberpress'); ?></title>
  <?php
    ...
    <div class="row">
      <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
          <div class="panel-heading"><h2><?php esc_html_e('MemberPress database upgrade not needed', 'memberpress'); ?></h2></div>
          <div class="panel-body">
            <p>&nbsp;</p>
            <p><?php esc_html_e('Your MemberPress database is already up to date', 'memberpress'); ?></p>
            <p>&nbsp;</p>
            <p><a class="btn btn-primary" href="<?php echo admin_url(); ?>"><?php esc_html_e('Back to Admin', 'memberpress'); ?></a></p>
          </div>
        </div>
      </div>
    </div>
