...
<div class="mp_wrapper">
  <?php if (!empty($welcome_message)) : ?>
    <div id="mepr-account-welcome-message">
        <?php echo MeprHooks::apply_filters('mepr_account_welcome_message', do_shortcode($welcome_message), $mepr_current_user); ?>
    </div>
  <?php endif; ?>

  <?php if (!empty($mepr_current_user->user_message)) : ?>
    <div id="mepr-account-user-message">
        <?php echo MeprHooks::apply_filters('mepr_user_message', wpautop(do_shortcode($mepr_current_user->user_message)), $mepr_current_user); ?>
    </div>
  <?php endif; ?>
  ...
  <form class="mepr-account-form mepr-form" id="mepr_account_form" action="" method="post" enctype="multipart/form-data" novalidate>
    ...
    <img src="<?php echo admin_url('images/loading.gif'); ?>" alt="<?php echo esc_attr_x('Loading...', 'ui', 'memberpress'); ?>" style="display: none;" class="mepr-loading-gif" />
