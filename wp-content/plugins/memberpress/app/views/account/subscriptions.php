...
if (!empty($subscriptions)) {
  ...
  <div class="mp_wrapper">
      ...
      <tbody>
        ...
        foreach ($subscriptions as $s) :
          ...
          <tr id="mepr-subscription-row-<?php echo esc_attr($s->id); ?>" class="mepr-subscription-row <?php echo (isset($alt) && !$alt) ? 'mepr-alt-row' : ''; ?>">
            ...
            <td data-label="<?php echo esc_attr_x('Active', 'ui', 'memberpress'); ?>"><div class="mepr-account-active"><?php echo $s->active; ?></div></td>
    ...
    <div id="mepr-subscriptions-paging">
      <?php if ($prev_page) : ?>
        <a href="<?php echo "{$account_url}{$delim}currpage={$prev_page}"; ?>">&lt;&lt; <?php echo esc_html_x('Previous Page', 'ui', 'memberpress'); ?></a>
      <?php endif; ?>
      <?php if ($next_page) : ?>
        <a href="<?php echo "{$account_url}{$delim}currpage={$next_page}"; ?>" style="float:right;"><?php echo esc_html_x('Next Page', 'ui', 'memberpress'); ?> &gt;&gt;</a>
      <?php endif; ?>
    </div>
