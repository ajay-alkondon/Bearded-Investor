  ...
  <nav id="mepr-account-nav" aria-label="<?php esc_attr_e('Account Navigation', 'memberpress'); ?>">
    <ul>
      <li class="mepr-nav-item <?php MeprAccountHelper::active_nav('home'); ?>">
        <a href="<?php echo MeprHooks::apply_filters('mepr_account_nav_home_link', $account_url . $delim . 'action=home'); ?>" id="mepr-account-home"><?php echo MeprHooks::apply_filters('mepr_account_nav_home_label', _x('Home', 'ui', 'memberpress')); ?></a>
      </li>
      <li class="mepr-nav-item <?php MeprAccountHelper::active_nav('subscriptions'); ?>">
        <a href="<?php echo MeprHooks::apply_filters('mepr_account_nav_subscriptions_link', $account_url . $delim . 'action=subscriptions'); ?>" id="mepr-account-subscriptions"><?php echo MeprHooks::apply_filters('mepr_account_nav_subscriptions_label', _x('Subscriptions', 'ui', 'memberpress')); ?></a>
      </li>
      <li class="mepr-nav-item <?php MeprAccountHelper::active_nav('payments'); ?>">
        <a href="<?php echo MeprHooks::apply_filters('mepr_account_nav_payments_link', $account_url . $delim . 'action=payments'); ?>" id="mepr-account-payments"><?php echo MeprHooks::apply_filters('mepr_account_nav_payments_label', _x('Payments', 'ui', 'memberpress')); ?></a>
      </li>
      <?php MeprHooks::do_action('mepr_account_nav', $mepr_current_user); ?>
      <li class="mepr-nav-item">
        <a href="<?php echo MeprUtils::logout_url(); ?>" id="mepr-account-logout"><?php echo esc_html_x('Logout', 'ui', 'memberpress'); ?></a>
      </li>
    </ul>
  </nav>
</div>
