...
<div id="body" style="width: 600px; background: white; padding: 40px; margin: 0 auto; text-align: left;">
  <div id="receipt">
    ...
    <div class="section" style="display: block; margin-bottom: 24px;"><?php printf(
        ...
        _x('We just saw that you weren\'t able to complete your signup for %1$s on %2$s.', 'ui', 'memberpress'),
        '{$product_name}',
        '{$blog_name}'
    ); ?></div>
    <div class="section" style="display: block; margin-bottom: 24px;"><?php printf(
        // Translators: %1$s: opening anchor tag, %2$s: closing anchor tag.
        _x('We\'d be really sad if you missed out so we just wanted to drop you a line to let you to know that it\'s easy to <strong>%1$scomplete your signup today%2$s</strong>.', 'ui', 'memberpress'),
