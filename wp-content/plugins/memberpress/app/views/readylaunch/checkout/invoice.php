  ...
  <div class="mp-table">
    ...
    <ul class="mp-cart-body">
      ...
      <li class="mp-cart-item">
        ...
        <div class="mp-cart-item-quantity"><?php echo $item['quantity']; ?></div>
            <?php endif; ?>
        <div class="mp-currency-cell"><?php echo MeprAppHelper::format_currency($item['amount'], true, false); ?></div>
      </li>
      <?php endforeach; ?>
    ...
    <div class="mp-cart-footer">
      ...
      <div class="mp-cart-subtotal">
        ...
        <div class="mp-currency-cell bb"><?php echo MeprAppHelper::format_currency($subtotal, true, false); ?></div>
      </div>
      <div>
        ...
        <div class="mp-currency-cell">
            <?php echo MeprAppHelper::format_currency($invoice['tax']['amount'], true, false); ?></div>
        </div>
      <?php endif; ?>
      <div>
        <div class="bt"><?php echo esc_html_x('Total', 'ui', 'memberpress'); ?></div>
        <div class="mp-currency-cell bt total_cell"><?php echo MeprAppHelper::format_currency($total, true, false); ?></div>
