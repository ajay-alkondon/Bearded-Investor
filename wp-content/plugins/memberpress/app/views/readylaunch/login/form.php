      ...
      <div id="mepr-template-login" class="mp_wrapper mp_login_form">
        ...
        <?php else : ?>
          ...
          <form name="mepr_loginform" id="mepr_loginform" class="mepro-form" action="<?php echo $login_url; ?>" method="post">
            ...
            <div class="mp-form-row mepr_username">
              <div class="mp-form-label">
                ...
                <label for="user_login" class="placeholder-text"><?php echo ($mepr_options->username_is_email) ? $uname_or_email_str : $uname_str; ?></label>
              </div>
          ...
          <div class="mepr-login-actions">
            <a
              href="<?php echo $forgot_password_url; ?>"
