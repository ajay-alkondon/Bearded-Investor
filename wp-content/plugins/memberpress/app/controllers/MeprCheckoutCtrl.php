...
class MeprCheckoutCtrl extends MeprBaseCtrl
{
    ...
    public function process_signup_form()
    {
        ...
        if ($is_existing_user) {
            ...
            try {
                ...
                // Log the new user in.
                if (MeprHooks::apply_filters('mepr_auto_login', true, sanitize_text_field(wp_unslash($_POST['mepr_product_id'])), $usr)) {
                    wp_signon(
                        [
        ...
        $txn->product_id = sanitize_text_field(wp_unslash($_POST['mepr_product_id']));
        $product         = $txn->product();
    ...
    public function display_payment_page()
    {
        ...
        $txn_id = intval(wp_unslash($_REQUEST['txn']));
