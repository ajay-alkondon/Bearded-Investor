...
class MeprMembersCtrl extends MeprBaseCtrl
{
    ...
    public function create_member()
    {
        ...
        $member = new MeprUser();
        $member->load_from_array(wp_unslash(array_map('sanitize_text_field', $_POST['member'])));
        ...
        $transaction = new MeprTransaction();
        $transaction->load_from_array(wp_unslash(array_map('sanitize_text_field', $_POST['transaction'])));
