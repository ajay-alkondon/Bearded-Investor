...
class MeprStripeConnectCtrl extends MeprBaseCtrl
{
    ...
    public function upgrade_notice()
    {
        ...
        <div class="notice notice-error mepr-notice is-dismissible" id="mepr_stripe_connect_upgrade_notice">
          <p>
            ...
            <p><a href="<?php echo admin_url('admin.php?page=memberpress-options#mepr-integration'); ?>" class="button button-primary"><?php esc_html_e('Re-connect Stripe Payments to Fix this Error Now', 'memberpress'); ?></a></p>
          </p>
    ...
    public function admin_notices()
    {
      ...
      <div class="notice notice-error mepr-removable-notice is-dismissible">
        <p><?php echo wp_strip_all_tags(urldecode(wp_unslash($_GET['error']))); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized ?></p>
      </div>
        <?php endif;
        ...
        <tr>
          <td valign="top">
            <div style="padding:30px;background-color:#f1f1f1;">
              ...
              <p><a href="<?php echo admin_url('admin.php?page=memberpress-options#mepr-integration'); ?>"><?php esc_html_e('Re-connect Stripe Payments to Fix this Error Now', 'memberpress'); ?></a></p>
            </div>
          </td>
        </tr>
            <?php
    ...
    public function process_update_creds()
    {
        ...
        if (isset($_GET['error'])) {
            wp_die(sanitize_text_field(wp_unslash($_GET['error'])));
        }
